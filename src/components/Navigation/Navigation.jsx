    ...
    <nav className={`navigation ${isMenuOpen ? 'navigation_open' : ''}`}>
      {isLoggedIn ? (
        <div className="navigation__links">
          <a href="/" onClick={handleLinkClick} className={`navigation__link ${isLight ? 'navigation__link_dark' : ''} ${isHome ? (isLight ? 'navigation__link_active-dark' : 'navigation__link_active') : ''}`}>
            Inicio
          </a>
          <a href="/saved-news" onClick={handleLinkClick} className={`navigation__link ${isLight ? 'navigation__link_dark' : ''} ${isSaved ? (isLight ? 'navigation__link_active-dark' : 'navigation__link_active') : ''}`}>
            Artículos guardados
          </a>
